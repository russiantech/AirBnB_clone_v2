...
Routes:
    ...
    /number_template/<n>: Returns an HTML page only if <n> is an integer.
        - Returns the value of <n> in the body.
    /number_odd_or_even/<n>: Returns an HTML page only if <n> is an integer.
